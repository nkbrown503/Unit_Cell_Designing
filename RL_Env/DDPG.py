...
class Agent:
    def __init__(self, input_dims,Type, alpha, beta,gamma,Start_Noise,Noise_Decay,TN,
        ...
        self.Trial_Num=Type
        self.actor = ActorNetwork(n_actions=n_actions, name='actor_SMax_'+self.Trial_Num)
        self.critic = CriticNetwork(name='critic_SMax_'.format(TN)+self.Trial_Num)
        self.target_actor = ActorNetwork(n_actions=n_actions,
                                         name='target_actor_SMax_'+self.Trial_Num)
        self.target_critic = CriticNetwork(name='target_critic_SMax_'+self.Trial_Num)
